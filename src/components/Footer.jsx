  ...
  return (
    ...
    <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
        <div className='max-w-80'>
            ...
            <p className='text-sm'>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo dolorum nihil, consequatur adipisci nam iure?
            </p>
            <div className='flex items-center gap-3 mt-4'>
                ...
                <img src={assets.linkendinIcon} alt="linknd-icon" className='w-6 ' />
